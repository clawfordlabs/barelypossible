(function () {
  ...
  window.barelyPossibleTrack = function (eventName, properties) {
  ...
  while (pendingEvents.length) {
    window.posthog.capture.apply(window.posthog, pendingEvents.shift());
  }
